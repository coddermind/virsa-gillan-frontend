...
export default function CreateTimeSlotPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      await apiClient.createTimeSlot(formData);
    ...
    <DashboardLayout>
      <div>
        <div className="mb-8">
          ...
          <h2 className="text-3xl font-bold text-[var(--text-primary)] mb-2 transition-colors duration-300">Create Time Slot</h2>
          <p className="text-[var(--text-secondary)] transition-colors duration-300">Add a new time slot for events</p>
        </div>
